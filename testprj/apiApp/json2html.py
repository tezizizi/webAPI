...
class Json2Dic():
    ...
    def dic2html(dic_data):
        ...
        onmousedown_url = "http://150.95.62.229/click/click_count/?cu="
        onmousedown_url0 = onmousedown_url + url0
        onmousedown_url1 = onmousedown_url + url1
        onmousedown_url2 = onmousedown_url + url2
        template_html ='''
    ...
    </div>'''.format(media_url_0=onmousedown_url0, onmousedown_url_0=onmousedown_url0, image_url_0=image_url0, title_0=title0, media_url_1=url1, onmousedown_url_1=onmousedown_url1, image_url_1=image_url1, title_1=title1,media_url_2=url2, onmousedown_url_2=onmousedown_url2, image_url_2=image_url2, title_2=title2)
